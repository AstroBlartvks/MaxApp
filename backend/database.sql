-- ============================================
-- Полный SQL дамп базы данных
-- ============================================
-- Этот файл содержит полную схему базы данных со всеми таблицами и миграциями
...
-- ============================================
-- Миграции (дополнительные таблицы и поля)
-- ============================================
...
-- ============================================
-- Права доступа (если используется пользователь app_user)
-- ============================================

-- Раскомментируйте следующие строки, если нужно предоставить права пользователю app_user:
