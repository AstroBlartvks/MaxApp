  ...
  const a2 = n.forwardRef((e3, a3) => {
    ...
    if (n.isValidElement(t2)) {
      const e4 = (function(e5) {
        let a4 = Object.getOwnPropertyDescriptor(e5.props, "ref")?.get, t3 = a4 && "isReactWarning" in a4 && a4.isReactWarning;
        if (t3) return e5.ref;
        if (a4 = Object.getOwnPropertyDescriptor(e5, "ref")?.get, t3 = a4 && "isReactWarning" in a4 && a4.isReactWarning, t3) return e5.props.ref;
...
var V = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsx)(P.Provider, { value: { size: p2 }, children: (0, import_jsx_runtime.jsxs)(h2, { ref: n2, className: v2, style: { "--MaxUi-AvatarContainer_size": `${p2}px`, ...l2 }, ...m2, children: [(0, import_jsx_runtime.jsx)(H, { children: X({ asChild: a2.asChild, children: _2 }, (a3) => (0, import_jsx_runtime.jsxs)("span", { className: y(Q.AvatarContainer__content, c2?.content), children: [a3, F(i2) && (0, import_jsx_runtime.jsx)("span", { className: y(Q.AvatarContainer__overlay, c2?.overlay), children: i2 })] }, "subtree-container")) }), F(s2) && (0, import_jsx_runtime.jsx)("span", { className: y(Q.AvatarContainer__rightBottomCorner, c2?.rightBottomCorner), children: s2 }), F(o2) && (0, import_jsx_runtime.jsx)("span", { className: y(Q.AvatarContainer__rightTopCorner, c2?.rightTopCorner), children: o2 })] }) });
});
...
var te = (e2) => {
  ...
  return (0, import_react.useEffect)(() => {
    a2.current = e2;
  }), (0, import_react.useMemo)(() => (...e3) => a2.current?.(...e3), []);
};
var ne = () => {
...
var be = (0, import_react.forwardRef)((a2, t2) => {
  ...
  return (0, import_react.useEffect)(() => {
    if (_2.current) return l2.current = _2.current.parentElement, null !== l2.current && l2.current.addEventListener("pointerdown", i2), () => {
      null !== l2.current && l2.current?.removeEventListener("pointerdown", i2);
    };
...
var ze = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)(B2, { ref: n2, className: S2, onClick: (e2) => {
    c2 || s2?.(e2);
  }, ...b2, ...C2, children: [F(l2) && (0, import_jsx_runtime.jsx)("span", { className: y(Se.Button__iconBefore, u2?.iconBefore), children: l2 }), c2 && (0, import_jsx_runtime.jsx)("span", { className: y(Se.Button__spinnerContainer, u2?.spinnerContainer), children: (0, import_jsx_runtime.jsx)(Te, { className: y(u2?.spinner), size: (A2 = h2, "small" === A2 ? 20 : 24), appearance: we(g2, v2) }) }), (0, import_jsx_runtime.jsx)(H, { children: X({ asChild: d2, children: o2 }, (a3) => (0, import_jsx_runtime.jsx)(fe, { className: y(Se.Button__content, u2?.content), children: a3 }, "subtree-container")) }), F(i2) && (0, import_jsx_runtime.jsx)("span", { className: y(Se.Button__indicator, u2?.indicator), children: Me(i2, g2, v2, p2) }), F(_2) && (0, import_jsx_runtime.jsx)("span", { className: y(Se.Button__iconAfter, u2?.iconAfter), children: _2 }), T2 && !I2 && (0, import_jsx_runtime.jsx)(be, { className: Se.Button__ripple })] });
  var A2;
});
...
var Ge = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { ref: n2, className: p2, ...c2, children: [F(i2) && (0, import_jsx_runtime.jsx)("div", { className: y(Re.CellHeader__content, s2?.content), children: i2 }), F(o2) && (0, import_jsx_runtime.jsx)("div", { className: y(Re.CellHeader__after, s2?.after), children: o2 })] });
});
...
var Fe = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)("span", { className: y(We, r2), children: [(0, import_jsx_runtime.jsx)("input", { ref: Z(p2, n2), className: y(_2?.input), onChange: (e2) => {
    l2?.(e2), m2(!e2.target.value);
  }, disabled: o2, ...s2 }), !d2 && !o2 && i2 && (0, import_jsx_runtime.jsx)(U, { className: y(Ye, _2?.clearButton), onClick: () => {
    p2.current && ((e2, a3 = "") => {
      const t2 = Object.getOwnPropertyDescriptor(HTMLInputElement.prototype, "value")?.set;
      t2?.call(e2, a3);
...
var Ze = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)("label", { className: c2, children: [F(_2) && (0, import_jsx_runtime.jsx)(fe, { className: y(qe.CellInput__before, i2?.before), maxLines: 1, children: _2 }), (0, import_jsx_runtime.jsx)(Fe, { ref: n2, className: y(qe.CellInput__body, i2?.body), innerClassNames: { input: y(qe.CellInput__input, i2?.input), clearButton: y(qe.CellInput__clearButton, i2?.clearButton) }, type: "text", disabled: o2, ...s2 })] });
});
...
var Ke = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)($e, { ref: n2, className: C2, asChild: d2, as: v2, parentChildren: s2, ...g2, children: [F(i2) && (0, import_jsx_runtime.jsx)("div", { className: y(Ve.CellSimple__before, m2?.before), children: i2 }), (0, import_jsx_runtime.jsx)(H, { children: X({ asChild: d2, children: s2 }, (a3) => (0, import_jsx_runtime.jsxs)("div", { className: y(Ve.CellSimple__content, m2?.content), children: [F(c2) && (0, import_jsx_runtime.jsx)("div", { className: y(Ve.CellSimple__overline, m2?.overline), children: c2 }), F(l2) && (0, import_jsx_runtime.jsx)("div", { className: y(Ve.CellSimple__title, m2?.title), children: l2 }), F(_2) && (0, import_jsx_runtime.jsx)("div", { className: y(Ve.CellSimple__subtitle, m2?.subtitle), children: _2 }), a3] }, "subtree-container")) }), (F(o2) || p2) && (0, import_jsx_runtime.jsxs)("div", { className: y(Ve.CellSimple__after, m2?.after), children: [o2, p2 && (0, import_jsx_runtime.jsx)(f, { className: y(Ve.CellSimple__chevron, m2?.chevron) })] })] });
});
...
var pa = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)(h2, { ref: n2, className: B2, ...g2, ...u2, children: [o2 && (0, import_jsx_runtime.jsx)("span", { className: y(ca.IconButton__spinnerContainer, i2?.spinnerContainer), children: (0, import_jsx_runtime.jsx)(Te, { className: y(i2?.spinner), size: (N2 = c2, "small" === N2 ? 20 : 24), appearance: sa(d2, p2) }) }), (0, import_jsx_runtime.jsx)(H, { children: X({ asChild: s2, children: r2 }, (a3) => (0, import_jsx_runtime.jsx)("span", { className: y(ca.IconButton__content, i2?.content), children: a3 }, "subtree-container")) }), f2 && !C2 && (0, import_jsx_runtime.jsx)(be, { className: ca.IconButton__ripple })] });
  var N2;
});
...
var ua = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)("label", { className: d2, children: [F(l2) && (0, import_jsx_runtime.jsx)("div", { className: y(da.Input__iconBefore, i2?.iconBefore), children: l2 }), (0, import_jsx_runtime.jsx)(Fe, { ref: n2, className: y(da.Input__body, i2?.body), withClearButton: o2, innerClassNames: { input: y(da.Input__input, i2?.input), clearButton: y(da.Input__clearButton, i2?.clearButton) }, ...p2 }), F(_2) && (0, import_jsx_runtime.jsx)("div", { className: y(da.Input__iconAfter, i2?.iconAfter), children: _2 })] });
});
...
var Ba = (0, import_react.forwardRef)((a2, n2) => {
  ...
  return (0, import_jsx_runtime.jsxs)("label", { className: s2, children: [(0, import_jsx_runtime.jsx)(T, { className: fa.SearchInput__icon }), (0, import_jsx_runtime.jsx)(Fe, { ref: n2, className: y(fa.SearchInput__body, _2?.body), innerClassNames: { input: y(fa.SearchInput__input, _2?.input), clearButton: y(fa.SearchInput__clearButton, _2?.clearButton) }, type: "text", placeholder: l2, ...i2 })] });
});
...
var Ta = (0, import_react.forwardRef)((a2, t2) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: i2, children: (0, import_jsx_runtime.jsx)("textarea", { ref: t2, className: y(Ia.Textarea__textarea, r2?.textarea), ..._2 }) });
});
